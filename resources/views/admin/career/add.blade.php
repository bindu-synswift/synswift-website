            ...
            <div>
                ...
                @csrf
                    <div class="row">
                        ...
                        <input type="text" id="fname" name="title" class="form-control" placeholder="Job Title">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 form-group">
                        <textarea type="text" id="fname" name="description" class="form-control" placeholder="Description"></textarea>
